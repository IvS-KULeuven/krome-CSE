...
then
    ...
    echo "You can also add options:"
    echo "-AP=<value>  Activating accretion photons for a companion with <value> K."
    echo "             Options are 4000 K, 6000 K and 10000 K."
    echo "-IP          Activating internal photons from the AGB star."
    echo "---------------------------------------------"
    exit 1
...
echo "UMIST $arg network has been converted to the correct format."
echo "KROME will now be built with the UMIST $arg network."
echo "---------------------------------------------"
echo ""
